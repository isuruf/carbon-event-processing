...
import org.wso2.carbon.event.processor.management.thrift.HAServiceClientThriftImpl;
import org.wso2.carbon.event.processor.management.util.HAManagerConstants;
...
public class HAManager {
    ...
    public HAManager(HazelcastInstance hazelcastInstance, String executionPlanName, int tenantId, ExecutionPlanRuntime executionPlanRuntime, int inputProcessors, CEPMembership currentCepMembershipInfo) {
        ...
        activeLock = hazelcastInstance.getLock(HAManagerConstants.PREFIX + ":" + tenantId + ":" + executionPlanName + ":ActiveLock");
        passiveLock = hazelcastInstance.getLock(HAManagerConstants.PREFIX + ":" + tenantId + ":" + executionPlanName + ":PassiveLock");
        ...
        membershipMap = hazelcastInstance.getMap(HAManagerConstants.MEMBERSHIP_MAP);
