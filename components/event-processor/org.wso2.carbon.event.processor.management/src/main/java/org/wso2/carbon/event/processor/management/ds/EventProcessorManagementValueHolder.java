...
public class EventProcessorManagementValueHolder {
    private static EventProcessingManagementService eventProcessingManagementService;
    ...
    public static EventProcessingManagementService getEventProcessingManagementService() {
        return eventProcessingManagementService;
    }

    public static void registerEventProcessingManagementService(EventProcessingManagementService eventProcessingManagementService) {
        EventProcessorManagementValueHolder.eventProcessingManagementService = eventProcessingManagementService;
    }
    ...
    public static void registerSiddhiManager(SiddhiManager siddhiManager) {
        EventProcessorManagementValueHolder.siddhiManager = siddhiManager;
    }
    ...
    public static void registerStreamDefinitionStore(AbstractStreamDefinitionStore abstractStreamDefinitionStore) {
        EventProcessorManagementValueHolder.streamDefinitionStore = abstractStreamDefinitionStore;
    }
    ...
    public static void registerEventStatisticsService(EventStatisticsService eventStatisticsService) {
        EventProcessorManagementValueHolder.eventStatisticsService = eventStatisticsService;
    }
    ...
    public static void registerHazelcastInstance(HazelcastInstance hazelcastInstance) {
        EventProcessorManagementValueHolder.hazelcastInstance = hazelcastInstance;
    }
    ...
    public static void setPersistenceStore(PersistenceStore persistenceStore) {
        EventProcessorManagementValueHolder.persistenceStore = persistenceStore;
    }
    ...
    public static void setScheduledExecutorService(ScheduledExecutorService scheduledExecutorService) {
        EventProcessorManagementValueHolder.scheduledExecutorService = scheduledExecutorService;
    }
    //
...
//    }
    ...
    public static void setUserRealm(UserRealm userRealm) {
        EventProcessorManagementValueHolder.userRealm = userRealm;
    }
    ...
    public static void setDataSourceService(DataSourceService dataSourceService) {
        EventProcessorManagementValueHolder.dataSourceService = dataSourceService;
    }
    ...
    public static void registerEventStreamManagerService(EventStreamService eventStreamService) {
        EventProcessorManagementValueHolder.eventStreamService = eventStreamService;
    }
    ...
    public static void setServerConfiguration(ServerConfigurationService serverConfiguration) {
        EventProcessorManagementValueHolder.serverConfiguration = serverConfiguration;
    }
    ...
    public static void setConfigurationContext(ConfigurationContextService configurationContext) {
        EventProcessorManagementValueHolder.configurationContext = configurationContext;
    }

    public static void registerStormManagerServer(StormManagerServer stormManagerServer) {
        EventProcessorManagementValueHolder.stormManagerServer = stormManagerServer;
    }
    ...
    public static void registerStormDeploymentConfig(StormDeploymentConfig stormDeploymentConfig) {
        EventProcessorManagementValueHolder.stormDeploymentConfig = stormDeploymentConfig;
    }
