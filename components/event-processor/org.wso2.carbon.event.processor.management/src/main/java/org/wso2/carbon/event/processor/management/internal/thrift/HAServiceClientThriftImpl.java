...
public class HAServiceClientThriftImpl implements HAServiceClient {
    ...
    public SnapshotData getSnapshot(int tenantId, String executionPlan, CEPMembership activeCepMembership, CEPMembership currentCepMembership) throws Exception {
        ...
        org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership cepMembershipOut = new org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership();
        ...
        try {
            ...
            org.wso2.carbon.event.processor.management.internal.thrift.data.SnapshotData snapshotDataIn = client.takeSnapshot(tenantId, executionPlan, cepMembershipOut);
