...
public class HAManagementService {
  ...
  public interface Iface {
    ...
    public org.wso2.carbon.event.processor.management.internal.thrift.data.SnapshotData takeSnapshot(int tenantId, String executionPlan, org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember) throws org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException, org.wso2.carbon.event.processor.management.internal.thrift.exception.InternalServerException, org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void takeSnapshot(int tenantId, String executionPlan, org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.takeSnapshot_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_takeSnapshot(int tenantId, String executionPlan, org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember) throws org.apache.thrift.TException
    {
    ...
    public org.wso2.carbon.event.processor.management.internal.thrift.data.SnapshotData recv_takeSnapshot() throws org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException, org.wso2.carbon.event.processor.management.internal.thrift.exception.InternalServerException, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void takeSnapshot(int tenantId, String executionPlan, org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember, org.apache.thrift.async.AsyncMethodCallback<takeSnapshot_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class takeSnapshot_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember;
      public takeSnapshot_call(int tenantId, String executionPlan, org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember, org.apache.thrift.async.AsyncMethodCallback<takeSnapshot_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public org.wso2.carbon.event.processor.management.internal.thrift.data.SnapshotData getResult() throws org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException, org.wso2.carbon.event.processor.management.internal.thrift.exception.InternalServerException, org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor implements org.apache.thrift.TProcessor {
    ...
    private static class takeSnapshot<I extends Iface> extends org.apache.thrift.ProcessFunction<I, takeSnapshot_args> {
      ...
      protected takeSnapshot_result getResult(I iface, takeSnapshot_args args) throws org.apache.thrift.TException {
        ...
        } catch (org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException anme) {
          result.anme = anme;
  ...
  public static class takeSnapshot_args implements org.apache.thrift.TBase<takeSnapshot_args, takeSnapshot_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.PASSIVE_MEMBER, new org.apache.thrift.meta_data.FieldMetaData("passiveMember", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership.class)));
    ...
    public takeSnapshot_args(
      ...
      org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember)
    {
      this();
      this.tenantId = tenantId;
    ...
    public takeSnapshot_args(takeSnapshot_args other) {
      ...
      if (other.isSetPassiveMember()) {
        this.passiveMember = new org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership(other.passiveMember);
      }
    }
    ...
    public org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership getPassiveMember() {
      return this.passiveMember;
    }

    public takeSnapshot_args setPassiveMember(org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership passiveMember) {
      this.passiveMember = passiveMember;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case PASSIVE_MEMBER:
        if (value == null) {
          ...
          setPassiveMember((org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership)value);
        }
        break;
        ...
        switch (field.id) {
          ...
          case 3: // PASSIVE_MEMBER
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.passiveMember = new org.wso2.carbon.event.processor.management.internal.thrift.data.CEPMembership();
  ...
  public static class takeSnapshot_result implements org.apache.thrift.TBase<takeSnapshot_result, takeSnapshot_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    public org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException anme; // required
    ...
    public takeSnapshot_result(
      ...
      org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException anme,
    ...
    public takeSnapshot_result(takeSnapshot_result other) {
      ...
      if (other.isSetAnme()) {
        this.anme = new org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException(other.anme);
      }
      if (other.isSetIse()) {
    ...
    public org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException getAnme() {
      return this.anme;
    }

    public takeSnapshot_result setAnme(org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException anme) {
      this.anme = anme;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ANME:
        if (value == null) {
          ...
          setAnme((org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException)value);
        }
        break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          case 0: // SUCCESS
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.success = new org.wso2.carbon.event.processor.management.internal.thrift.data.SnapshotData();
          ...
          case 1: // ANME
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.anme = new org.wso2.carbon.event.processor.management.internal.thrift.exception.NotAnActiveMemberException();
          ...
          case 2: // ISE
            if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
              this.ise = new org.wso2.carbon.event.processor.management.internal.thrift.exception.InternalServerException();
              this.ise.read(iprot);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
