 ...
 * under the License.
 */
package org.wso2.carbon.event.processor.management.thrift;
...
import org.wso2.carbon.event.processor.management.SnapshotData;
import org.wso2.carbon.event.processor.management.HAServiceClient;
...
public class HAServiceClientThriftImpl implements HAServiceClient {
    ...
    @Override
    public SnapshotData getSnapshot(int tenantId, String executionPlan, org.wso2.carbon.event.processor.management.CEPMembership activeCepMembership, org.wso2.carbon.event.processor.management.CEPMembership currentCepMembership) throws Exception {
        ...
        CEPMembership cepMembershipOut = new CEPMembership();
        ...
        try {
            ...
            org.wso2.carbon.event.processor.management.thrift.data.SnapshotData snapshotDataIn = client.takeSnapshot(tenantId, executionPlan, cepMembershipOut);
