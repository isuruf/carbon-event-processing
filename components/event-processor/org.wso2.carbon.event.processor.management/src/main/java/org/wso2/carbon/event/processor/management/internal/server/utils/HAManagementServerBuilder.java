...
* under the License.
*/
package org.wso2.carbon.event.processor.management.internal.server.utils;
...
public final class HAManagementServerBuilder {
    ...
    private static void populatePorts(OMElement config,
        ...
        if (receiverPort != null) {
            try {
                haConfiguration.setDataReceiverPort(Integer
    ...
    private static void populateHostName(OMElement config,
        ...
        if (receiverHostName != null && receiverHostName.getText() != null
            ...
            haConfiguration.setReceiverHostName(receiverHostName.getText());
        }
    }
    ...
    public static void populateConfigurations(int portOffset,
        ...
        if (initialConfig != null) {
            populatePorts(initialConfig, portOffset, haConfiguration);
            populateHostName(initialConfig, haConfiguration);
        }
    }
